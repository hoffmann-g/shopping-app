...
public interface CartService {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "api/cart/{customer-id}/quantities")
    public Map<Long, Integer> getCartQuantities(@PathVariable(value = "customer-id") Long customerId);

    @RequestMapping(method = RequestMethod.GET, value = "api/cart/{customer-id}/coupon")
    public String getCartCoupon(@PathVariable(value = "customer-id") Long customerId);

    @RequestMapping(method = RequestMethod.DELETE, value = "api/cart/{customer-id}")
